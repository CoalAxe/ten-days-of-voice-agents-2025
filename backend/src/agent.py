...
def seed_database():
    ...
    if not os.path.exists(path):
        sample_data = [
            {
                "userName": "Rohit",
                "securityIdentifier": "78652",
                "cardEnding": "5521",
                "transactionName": "Metro Electronics",
                "transactionAmount": "$320.00",
                "transactionTime": "10:45 AM IST",
                "transactionSource": "flipkart.com",
                "case_status": "under_investigation",
                "notes": "Flagged due to unusual purchase pattern."
            },
            {
                "userName": "Sarah",
                "securityIdentifier": "883098",
                "cardEnding": "1986",
                "transactionName": "Unknown Crypto Exchange",
                "transactionAmount": "$22,500.00",
                "transactionTime": "5:30 AM PST",
...
if __name__ == "__main__":
    cli.run_app(WorkerOptions(entrypoint_fnc=entrypoint, prewarm_fnc=prewarm))ewarm))
